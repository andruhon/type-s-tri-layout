...
module keycap() {
    ...
    if (style=="sharp") {
        difference() {
                ...
                translate([0, 0, 2.9*height]) rotate([0, 90, 0]) cylinder(bottom_side,r=2*height, $fn=50, center=true);
        }
    }
    ...
    if (style=="postsoft") {
        minkowski() {
            difference() {
                ...
                translate([0, 0, 2.805*height]) rotate([0, 90, 0]) cylinder(bottom_side,r=2*height, $fn=50, center=true);
            }    
