...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_split_3x5_3(
        KC_ESC,  KC_BTN2, KC_MS_U, KC_BTN1, XXXXXXX,                            KC_MINUS,   KC_7,    KC_8,    KC_9,     KC_0,
        XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX,                            KC_EQUAL,   KC_4,    KC_5,    KC_6,     XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN3,                            KC_BTN1,    KC_1,    KC_2,    KC_3,     XXXXXXX,
                                XXXXXXX, _______, KC_BSPC,          XXXXXXX,  _______,  XXXXXXX
    ),
    ...
    [3] = LAYOUT_split_3x5_3(
        ...
        KC_LSFT, KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX,                            XXXXXXX,    KC_RALT, KC_RGUI, KC_RCTL,  KC_RSFT,
